...
class bomb_bullet(Base):
    #炸弹类
    def __init__(self, screen_temp):
        Base.__init__(self, screen_temp, random.randint(0, 1000), 0, "./images/bomb.png")
...
class supply(Base):
    #补给类
    def __init__(self, screen_temp):
        Base.__init__(self, screen_temp, random.randint(45, 400), -300, "./images/bomb-1.gif")
...
class clear_bullet(Base):
    def __init__(self, screen_temp):
        Base.__init__(self, screen_temp, random.randint(45, 400), 0, "./images/bomb-2.gif")
        self.alive = False
...
class EnemyPlane(object):
    ...
    def __create_images(self):
        ...
        self.bomb_list.append(pygame.image.load("./images/enemy0_down2.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy0_down3.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy0_down4.png"))

    def fire(self):
        #利用随机数来控制敌机的开火，1/0.1的概率
...
class Boss(EnemyPlane):
    ...
    def __create_images(self):
        #self.bomb_list.append(pygame.image.load("./images/enemy2.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy2.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy2_down1.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy2_down2.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy2_down3.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy2_down4.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy2_down5.png"))
        self.bomb_list.append(pygame.image.load("./images/enemy2_down6.png"))
...
def judge1(hero,enemy):
    ...
    for bullet1 in hero.bullet_list:
        if bullet1.y in range(int(enemy.y),int(enemy.y + 30)) and bullet1.x in range(int(enemy.x-10),int(enemy.x + 50)):
            ...
            enemy.bomb()
        if bullet1.y < 0 or bullet1.x < 0 or bullet1.x > 1000: #删除越界的玩家子弹
            hero.bullet_list.remove(bullet1) 
...
def main():
    ...
    atlas = pygame.image.load("./images/bg.png")
    #创建玩家飞机
    hero = Hero(screen)
    #创建敌机群
